...
class SpriteObject:
  ...
  def get_sprite_projection(self):
    ...
    self.render_text_above_sprite(pos)

  def render_text_above_sprite(self, pos):
    if self.is_player:
      text_surface, _ = self.font.render(self.player.name, (255, 255, 255))
      text_width, text_height = text_surface.get_size()
      text_pos = pos[0] + (self.sprite_half_width - text_width // 2), pos[1] - text_height - 5
      self.game.ray_cast.objects_to_render.append((self.norm_dist, text_surface, text_pos))
